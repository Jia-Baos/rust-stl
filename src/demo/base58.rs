...
#[cfg(test)]
mod tests {
    use crate::demo::{Decoder, Encoder};    // 在main中调用时需要再引入Decode和Encoder

    #[test]
    fn test_base58() {
        assert_eq!("abc".encode_to_base58(), "ZiCa");
        assert_eq!("ZiCa".decode_from_base58().unwrap(), "abc");

        assert_eq!("我爱你".encode_to_base58(), "3wCHf2LRNuMmh");
        assert_eq!("3wCHf2LRNuMmh".decode_from_base58().unwrap(), "我爱你");

        assert_eq!("我愛你".encode_to_base58(), "3wCHf1q5U5pUP");
        assert_eq!("3wCHf1q5U5pUP".decode_from_base58().unwrap(), "我愛你");
    }
}
